...
class RobotMovements:
    ...
    @inlineCallbacks
    def point(self):
        """Triggered by TRIGGER5"""
        debug_list.append("point() called")
        print(" want to point")
        yield perform_movement(
            self.session,
            frames=[
                {"time": 400, "data": {"body.torso.yaw": 0.500, "body.arms.left.upper.pitch": -0.59}},
                {"time": 1200, "data": {"body.arms.left.lower.roll": -1.70, "body.arms.right.upper.pitch": 1.00}},
                {"time": 2000, "data": {"body.arms.left.lower.roll": 0.0, "body.arms.right.upper.pitch": 0.0}},
                {"time": 2400, "data": {"body.torso.jaw": 0.0, "body.arms.left.upper.pitch": 0.0}}
            ],
            force=True      
        )
